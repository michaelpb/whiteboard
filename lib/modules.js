...
module.exports = {
    _preload: {
        ...
        css: [
            ...
            _npm('medium-editor-insert-plugin/dist/css/medium-editor-insert-plugin.min.css'),
        ],
        script: [
            ...
            //_npm('medium-editor-markdown/dist/me-markdown.standalone.js'),
            // All for medium-editor-insert-plugin :'(
            /*
            _static('js/jquery-2.1.3.js.tweaked.js'),
            _npm('medium-editor/dist/js/medium-editor.js'),
            //_npm('handlebars/handlebars.runtime.min.js'),
            _npm('handlebars/dist/handlebars.js'),
            _npm('jquery-sortable/source/js/jquery-sortable-min.js'),
            _npm('blueimp-file-upload/js/vendor/jquery.ui.widget.js'),
            _npm('blueimp-file-upload/js/jquery.iframe-transport.js'),
            _npm('blueimp-file-upload/js/jquery.fileupload.js'),
            //_npm('medium-editor-insert-plugin/dist/js/medium-editor-insert-plugin.min.js'),
            */
        ],
    },
    start: {
